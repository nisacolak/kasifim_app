...
class _RestClient implements RestClient {
  _RestClient(
    ...
    baseUrl ??= 'https://api.kasifim.com/api/';
  }
  ...
  @override
  Future<RestaurantResponseModel> getRestaurant(String token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RestaurantResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = RestaurantResponseModel.fromJson(_result.data!);
    return value;
  }
